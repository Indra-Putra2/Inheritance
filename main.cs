...
namespace LatihanInheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("Indra", 18);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("Thomas", 36, "190345", "Physic");
            teacher.GetNameAndAge();

            Student student = new Student("Indra Putra Gemilang", 18, "19.11.2780", "indra.2105@students.amikom.ac.id");
